...
public class MelonControl : MonoBehaviour
{
    bool kapanis;
    public AudioClip r0;
    public AudioClip r1;
    ...
    public GameObject Melon_Counter;
    ...
    void Start()
    {
        ...
        transform.Find("closing").GetComponent<ParticleSystem>().Stop();
        ...
        basilimi = false;
        transform.Find("Melon_Counter").GetComponent<TextMeshPro>().enabled = false;
    ...
    void OnCollisionStay2D(Collision2D other)
    {
        ...
        {
            BuObje.transform.Find("Red_Alert_Melon").GetComponent<Animator>().SetBool("red_alert_melon", true);
        }
    ...
    {
        BuObje.transform.Find("Red_Alert_Melon").GetComponent<Animator>().SetBool("red_alert_melon", false);
    }
    void CollisionWork(Collision2D other)
    {
        ...
        else
        {
            if (other.gameObject.tag == "melon")
            {
                ...
                if (basilimi)
                {
                    ...
                    if (other.gameObject.GetComponent<MelonControl>().Explode_Counter > 1)
                    {
                        Explode_Counter = Explode_Counter + other.gameObject.GetComponent<MelonControl>().Explode_Counter;
                    }
                    else
                    {
                        Explode_Counter++;
                    ...
                    transform.Find("Melon_Counter").GetComponent<TextMeshPro>().text = Explode_Counter.ToString();
                    ...
                    transform.Find("Melon_Counter").GetComponent<TextMeshPro>().enabled = true;
        ...
        IEnumerator WaitAndDestroy()
        {
            ...
            if (!kapanis)
            {
                ...
                if (!transform.Find("closing").GetComponent<ParticleSystem>().isPlaying)
                {
                    transform.Find("closing").GetComponent<ParticleSystem>().Play();
                }


                yield return new WaitForSeconds(0.5f); // 1 saniye bekle
                GameObject.Find("GameObject").GetComponent<Stats>().GeneralExpFoods++;
                GameObject.Find("GameObject").GetComponent<Stats>().ExpMelon++;
                Destroy(BuObje);
            }
